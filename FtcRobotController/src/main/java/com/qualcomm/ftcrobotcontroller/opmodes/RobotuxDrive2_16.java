...
public class RobotuxDrive2_16 extends OpMode {
...
//LIFT
        ...
        else if (gamepad1.right_trigger>0||gamepad2.left_trigger>0) {
            lift.setPower(-1.0);
            System.out.println("robo lift: " + lift.getCurrentPosition());
        }
        else{
...
//ALL STOP
        if(gamepad1.a && gamepad1.b || gamepad2.dpad_left || gamepad2.dpad_right) {
            tilt.setPower(0);
            lift.setPower(0);
            pickUp.setPower(0);
        }
